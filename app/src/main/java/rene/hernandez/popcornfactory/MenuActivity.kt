...
class MenuActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var gridSeries : GridView = findViewById(R.id.gridSeries)

        cargarSeries()
        adapter = MovieAdapter(this, series)
...
class MovieAdapter: BaseAdapter{
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        var vista = inflater.inflate(R.layout.presentacion, null)
        ...
        img.setOnClickListener{
            var intent = Intent(context, Descripcion::class.java)
